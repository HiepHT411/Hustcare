package com.hoanghiep.hustcare.models.user;
...
import com.hoanghiep.hustcare.utils.DatabaseOperator;
...
public class User {
	...
	public String checkUser(String username, String password) {
		...
		String access = "false";
		try {
			ArrayList<ArrayList<String>> result = tmpOperator.showTableData("sys_user", "password,user_type",
					("user_name = '" + username + "'"));
	...
	public boolean saveLogin(String username) {
		...
		String sql = "UPDATE sys_user SET online=1,login=NOW() " + "WHERE user_name ='" + username + "';";
	...
	public boolean saveLogout(String username) {
		...
		String sql = "UPDATE sys_user SET online=0,logout=NOW() " + "WHERE user_name ='" + username + "';";
	...
	public boolean sendMessage(String sender, String receiver, String subject, String message) {
		...
		String sql = "INSERT INTO user_message " + "(message_id,reciver,sender,subject,message,date) VALUES " + "('"
	...
	public ArrayList<ArrayList<String>> getMessages() {
		String sql = "SELECT " + "sender,subject,message,date,rd,message_id " + "FROM user_message "
				+ "WHERE reciver ='" + this.userID + "' " + "ORDER BY date DESC;";
	...
	public boolean deleteMessage(String msgID) {
		String sql = "DELETE FROM user_message " + "WHERE message_id ='" + msgID + "';";
	...
	public String getProfilePic() {
		String image = "p2.png";
		String sql = "SELECT " + "profile_pic " + "FROM sys_user " + "WHERE sys_user.user_name = '" + this.username
				+ "';";
	...
	public String getProfilePic(String userID) {
		String image = "p2.png";
		String sql = "SELECT " + "profile_pic " + "FROM sys_user " + "WHERE sys_user.user_name = '" + userID + "';";
	...
	public boolean setProfilePic(String name) {
		...
		String sql = "UPDATE sys_user " + "SET profile_pic = '" + name + "'" + "WHERE sys_user.user_name = '"
				+ this.username + "';";
	...
	public ArrayList<ArrayList<String>> getName(String userID) {
		String sql = "SELECT " + "person.first_name, person.last_name, sys_user.user_type "
				+ "FROM person INNER JOIN sys_user ON person.user_id = sys_user.user_id " + "WHERE sys_user.user_id = '"
				+ userID + "';";
	...
	public ArrayList<ArrayList<String>> getUserNameAndID() {
		String sql = "SELECT " + "person.first_name, person.last_name, sys_user.user_type,sys_user.user_id "
	...
	public boolean setMessageRead(String msgID) {
		String sql = "UPDATE user_message " + "SET rd = '" + 1 + "'" + "WHERE user_message.message_id = '" + msgID
				+ "';";
...
//		String sql = "SELECT " + "user_message.sender " + "FROM user_message WHERE user_message.message_id = '" + msgid
//				+ "';";
//
//		ArrayList<ArrayList<String>> data = null;
//
...
//	}
	/*
	 * public static void main(String[] args) { User u1 = new User("user001");
	 * boolean access = u1.login("sys_user","user001","1234");
